...
/** 
 * DAO for table "SHOPPING_BEAN".
*/
public class ShoppingBeanDao extends AbstractDao<ShoppingBean, Long> {

    public static final String TABLENAME = "SHOPPING_BEAN";

    /**
     * Properties of entity ShoppingBean.<br/>
    ...
    public ShoppingBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ShoppingBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHOPPING_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SHOPPING_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ShoppingBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ShoppingBean entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
        stmt.bindLong(2, entity.getCommodityId());
    ...
    @Override
    public ShoppingBean readEntity(Cursor cursor, int offset) {
        ShoppingBean entity = new ShoppingBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ShoppingBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ShoppingBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ShoppingBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ShoppingBean entity) {
