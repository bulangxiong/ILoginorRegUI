...
public class OneEvaluateAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        TwoEvaluateAdapter twoEvaluateAdapter = new TwoEvaluateAdapter(context);
        //第二个添加数据
        twoEvaluateAdapter.addItem(detailList);
        one.oderrecy4.setAdapter(twoEvaluateAdapter);
